...
public class QALD {
    ...
    public static void main(String[] args) {
        ArrayList<Question> q = getQuestions("src/Reader/Files/qald_test.xml");
        ...
        //writeQuestions("src/Reader/Files/qald_test.xml", query, answers);
        int a = 1;
    }
    ...
    public static void writeQuestions(String fileName, List<Question> parsedQuestions) {
        try {
            ...
            Result output = new StreamResult(new File("src/Reader/Files/output.xml"));
            ...
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (onlyDBO.equals("true") || onlyDBO.equals("false")) {
                    if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        if (!query.contains("yago") && !query.contains("OUT OF SCOPE")) {
                            if (!question.equals("") && !query.equals("")) {
                                questions.add(q1);
                            }
                        }
