...
public class Stemmer {
    ...
    public static void main(String[] args) {
        ...
        double iScore = stemmer.stringSimilarity(f, s);
        System.out.println(iScore);
        System.out.print(stemmer.process("headquarters"));
    }
    ...
    public double stringSimilarity(String f, String s){
        double similarity = 0;

        int lDistance = levenshteinDistance(f, s);
        double score = (double) (f.length() - lDistance) / (double) f.length();
